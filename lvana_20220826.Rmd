...
header-includes:
  ...
  - \setbeamertemplate{itemizeitem}{$a$}
---
...
* Useful guidelines in creating inclusive communities and events
...
* R User Local Groups (see all [R Consortium](https://www.r-consortium.org/all-projects/r-user-group-support-program))
